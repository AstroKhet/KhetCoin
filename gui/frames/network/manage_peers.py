...
class ManagePeersFrame(tk.Frame):
    ...
    def _config_peer_details(self):
        ...
        details_map = {
            ...
            "Last Block": format_age(peer.last_block_ago) if peer.last_block_timestamp != 0 else "Never",
            "Last Transaction": format_age(peer.last_tx_ago) if peer.last_tx_timestamp !=0 else "Never",
            "Last Send": format_age(peer.last_send_ago) if peer.last_send_timestamp != 0 else "Never",
            "Last Receive": format_age(peer.last_recv_ago) if peer.last_recv_timestamp != 0 else "Never",
